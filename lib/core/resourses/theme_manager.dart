...
import 'package:wallpaper_app/core/resourses/style_manager.dart';
...
class AppTheme {
  ...
  static ThemeData light = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch(primarySwatch: AppColor.primarySwatch)
        .copyWith(
            background: AppColor.backgroundWhite, brightness: Brightness.light),
  );
  ...
  static ThemeData dark = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch(primarySwatch: AppColor.primarySwatch)
        .copyWith(
            background: AppColor.backgroundBlack, brightness: Brightness.dark),
  );
}
